...
const nearbyLocations: NearbyLocation[] = [
  {
    ...
    type: 'hospital',
    address: 'Panchakki Road, Chhatrapati Sambhajinagar',
    distance: 2.3,
    eta: 6,
  ...
  },
  {
    ...
    type: 'hospital',
    address: 'MIDC, Chikalthana, Chhatrapati Sambhajinagar',
    distance: 4.1,
    eta: 10,
  ...
  },
  {
    ...
    type: 'police_station',
    address: 'City Chowk, Chhatrapati Sambhajinagar',
    distance: 1.5,
    eta: 4,
    coordinates: { lat: 19.8762, lng: 75.3433 },
  },
  ...
  },
  {
    ...
    distance: 1.2,
    eta: 3,
    coordinates: { lat: 19.8780, lng: 75.3450 },
    available: true,
  },
];
...
export default function DispatchClient() {
  ...
  useEffect(() => {
    const mockEmergencies: Emergency[] = [
      {
        ...
        recommendedHospital: 'Government Medical College & Hospital',
        estimatedResponseTime: 8,
      },
      {
        id: 'EMG002',
        patientName: 'Priya Sharma',
        location: 'MIDC Chikalthana, Chhatrapati Sambhajinagar',
        coordinates: { lat: 19.8520, lng: 75.3250 },
        severity: 'high',
        aiScore: 82,
        ...
        recommendedHospital: 'Sahyadri Speciality Hospital',
      ...
      },
      {
        ...
        recommendedHospital: 'Care Hospital',
    ...
    const mockAmbulances: AmbulanceUnit[] = [
      {
        id: 'AMB001',
        vehicleNumber: 'MH-20-AB-1234',
        status: 'available',
        location: 'City Chowk Station',
        coordinates: { lat: 19.8780, lng: 75.3450 },
      ...
      {
        id: 'AMB003',
        vehicleNumber: 'MH-20-AB-9012',
        status: 'busy',
        location: 'En route to GMC Hospital',
        coordinates: { lat: 19.8750, lng: 75.3400 },
